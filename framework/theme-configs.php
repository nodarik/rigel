	...
	'icon' => 'el el-exclamation-sign',
					'fields' => array(
						array(
							...
							'type' => 'info',
							'desc'     => '
											<h3 style="text-align: center; border-bottom: none;">Welcome to the Options panel of the Rigel theme!</h3>
											...
											<p style="text-align: center;">Theme documentation you will find in the archive with the theme in the "Documentation" folder. </p>
												<p style="text-align: center;">Theme documentation is located <a href="http://rigel.radiuzz.com/documentation/" target="_blank" title="theme documentation">here</a>.</p>
											<p style="text-align: center;">If you have some questions on the theme, you can send them to our PM on <a href="http://themeforest.net/user/radiuzz">Themeforest.net</a>, you can send us email directly to <a href="mailto:studio@radiuzz.com">studio@radiuzz.com</a>, or you can post your questions on our <a href="http://support.radiuzz.com">Support Forum</a>.</p>
												',
						),
					),
				);
...
<li><h3>PHONE</h3><h5>1-800-800-0000<br>1-808-801-2222</h5>
		...
		array(
			...
			'default' => wp_kses(__('2016 © Rigel Template By<a href="http://radiuzz.com"> Radiuzz.com </a>', 'rigel'), array( 'a' => array( 'href' => array() ) )),
			'args' => array(
				'teeny' => true,
				'textarea_rows' => 10
			)
