        ...
        <div class="rigel_blog_item_holder">
        	 <div class="rigel_blog_head ">
                ...
                <div class="rigel_blog_meta">
                    ...
                    <a href="<?php esc_url(the_permalink()) ?>#comments"><?php comments_number('0','1','%')?>  <?php echo esc_html__("Comments","rigel")?></a>
                </div>
            </div>
            ...
            <div class="rigel_blog_item_content">
            	<div class="rigel_blog_item_main_content">
					<?php the_content('<div class="rigel_read_more text-center"><a class="rigel_readmore_btn" href="'. esc_url(get_permalink($post->ID)) . '">'. esc_html__(" Read More","rigel") .'</a></div>'); ?>
            	</div>
                <br>
