    ...
    <div class="col-md-12">
    	<div class="row">
            ...
            <div class="col-md-12 col-sm-12 text-center">
            	<h4 class="rigel_textimponial_author"><?php echo get_option( 'date_format' ); ?>,&nbsp;&nbsp; <?php esc_html_e('By','rigel'); ?>  <?php the_title(); ?></h4>
                <h6 class="rigel_textimponial_author_small"><?php echo get_post_meta($post->ID, 'testimonials-descr', true); ?></h6>
            </div>
