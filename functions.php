...
/* Theme Stylesheets */
/* ------------------------------------------------------------------------ */
if(strpos($_SERVER['HTTP_USER_AGENT'], 'MSIE') == true) { //Internet Explorer Styles
	...
	{   
		...
		wp_enqueue_style( 'bxslider_css', get_template_directory_uri() . '/framework/css/jquery.bxslider.css', array(), '1', 'all' );
